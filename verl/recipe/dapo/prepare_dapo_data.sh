...
export VERL_HOME="/home/azureuser/cloudfiles/code/SRC/RL/verl"
export TRAIN_FILE=${TRAIN_FILE:-"${VERL_HOME}/BT/data/dapo-math-17k.parquet"}
export TEST_FILE=${TEST_FILE:-"${VERL_HOME}/BT/data/aime-2024.parquet"}
